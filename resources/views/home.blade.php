                            ...
                            <div class="w-auto">
                                ...
                                <div class="tweet-user-img">
                                    <span class="w-12 rounded-full overflow-hidden mr-2">
                                        <img src="https://i.pravatar.cc/73" alt="tweet user image">
                                    </span>
                                </div>
                                <!-- tweet user img end -->
                            </div>
                                ...
                                <div class="tweet-tweet">
                                    ...
                                    <div class="tweet-info-bar flex items-center ">
                                        ...
                                        <span class="tweet-username relative block">
                                                <a href="#" class="hover:underline text-gray-900 font-bold text-base mr-1">{{ $tweet->name }}</a>
                                        ...
                                        <span class="text-gray-600 text-base font-light tracking-wide inline-block ml-1">{{(new Carbon\Carbon($tweet->created_at))->diffForHumans()}}</span>
                                    </div>
                                    <!-- tweet info bar end -->
                                    <!-- tweet detail start -->
                                    ...
                                    <div class="tweet-images py-3 pb-1">
                                        <span class="inline-block rounded-lg overflow-hidden h-64 shadow">
                                            <img class="h-64 object-cover object-bottom w-full" src="https://source.unsplash.com/random/718x799" alt="tweet image">
                                        </span>
                                    </div>
                                    <!-- tweet images end -->
